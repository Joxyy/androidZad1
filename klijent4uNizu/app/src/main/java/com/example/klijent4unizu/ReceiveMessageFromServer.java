...
public class ReceiveMessageFromServer implements Runnable{
    MainActivity parent;
    BufferedReader br;
    private static boolean pauseReading = false;


    public static void setPauseReading(boolean pauseReading) {
    ...
    public void run() {
        ...
        while (true) {
            ...
            */
                    ...
                    line = SocketSingleton.ReadFromServer();
                 ...
                 */
                        ...
                        parent.runOnUiThread(() -> {
                            try {
                                parent.startTheGame(plyr1, plyr2);
